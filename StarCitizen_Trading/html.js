...
function displayCommodity(item, buy = [], sell = []) {
    ...
    if (profit_sorted.length > 0)
        ...
        best_route = `<tr><td>${profit_sorted[0].buy.terminal_name} -> ${profit_sorted[0].sell.terminal_name}</td><td style="text-align:right;">${readable_number(profit_sorted[0].profit)} aUEC</td><td style="text-align:right;">${readable_number(profit_sorted[0].amount)} SCU</td><td style="text-align:right;">( ${readable_number(profit_sorted_avg[0].investment)} aUEC )</td></tr>
        <tr><td>${profit_sorted_avg[0].buy.terminal_name} -> ${profit_sorted_avg[0].sell.terminal_name}</td><td style="text-align:right;">~ ${readable_number(profit_sorted_avg[0].profit)} aUEC</td><td style="text-align:right;">~ ${readable_number(profit_sorted_avg[0].amount)} SCU</td><td style="text-align:right;">( ~ ${readable_number(profit_sorted_avg[0].investment)} aUEC )</td></tr>`;
        }
    return `
